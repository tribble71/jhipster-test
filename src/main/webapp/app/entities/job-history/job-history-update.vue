  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipstertestApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('jhipstertestApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.startDate')" for="job-history-startDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.endDate')" for="job-history-endDate"></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.language')" for="job-history-language"></label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                :key="language"
                :value="language"
                :label="t$('jhipstertestApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.department')" for="job-history-department"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipstertestApp.jobHistory.employee')" for="job-history-employee"></label>
