...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Internal Usability Representative');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Internal Usability Representative');

      cy.get(`[data-cy="minSalary"]`).type('16317');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '16317');

      cy.get(`[data-cy="maxSalary"]`).type('12265');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '12265');
