...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Garrison');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Garrison');

      cy.get(`[data-cy="lastName"]`).type('Jaskolski');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Jaskolski');

      cy.get(`[data-cy="email"]`).type('Malika_Flatley65@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Malika_Flatley65@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('stigmatize');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'stigmatize');

      cy.get(`[data-cy="hireDate"]`).type('2025-02-06T15:39');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-02-06T15:39');

      cy.get(`[data-cy="salary"]`).type('9209');
      cy.get(`[data-cy="salary"]`).should('have.value', '9209');

      cy.get(`[data-cy="commissionPct"]`).type('15355');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '15355');
