...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'obstruct because' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('throughout');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'throughout');
