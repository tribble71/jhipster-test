...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('hm');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'hm');

      cy.get(`[data-cy="postalCode"]`).type('mid');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'mid');

      cy.get(`[data-cy="city"]`).type('East Khalilberg');
      cy.get(`[data-cy="city"]`).should('have.value', 'East Khalilberg');

      cy.get(`[data-cy="stateProvince"]`).type('unhealthy clearly');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'unhealthy clearly');
