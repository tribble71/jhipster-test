...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('hopelessly');
      cy.get(`[data-cy="title"]`).should('have.value', 'hopelessly');

      cy.get(`[data-cy="description"]`).type('including though');
      cy.get(`[data-cy="description"]`).should('have.value', 'including though');
